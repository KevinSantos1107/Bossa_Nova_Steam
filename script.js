...
document.addEventListener('DOMContentLoaded', () => {
  ...
  (function initThemeToggle() {
    ...
    function applyTheme(theme, instant) {
      if (instant) {
        // 1. Paralisa todas as transitions adicionando a classe
        root.classList.add('no-transitions');
        // 2. Força um reflow síncrono para garantir que o browser aplicou a classe
        // ANTES de mudarmos os atributos de tema. Isso mata o flicker!
      ...
      // 4. Sincroniza a cor de fundo nativa do HTML
      if (theme === 'dark') {
        root.style.backgroundColor = '#0B1018';
      ...
      if (instant) {
        // 5. Devolve as transições apenas no frame seguinte, quando o novo tema já está pintado
